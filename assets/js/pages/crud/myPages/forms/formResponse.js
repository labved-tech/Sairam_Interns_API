...
/* Class definition */
const FormResponseCRUD = (function () {
    const _buttonSpinnerClasses = 'spinner spinner-right spinner-white pr-15';

    /*   Private functions */
    function _FormResponse() {
      var dataSet;
      ...
      const options = {
          ...
          source: {
              read: {
              method: 'get',
              url: `${HOST_URL}/api/v1/form-response/table`,
              params: {
                fields: '_id,_formId,response,createdBy,createdAt,updatedAt',
            },
              map: function(raw) {
                  // sample data mapping
                  // console.log('raw', raw);
                  ...
                  if (typeof raw.formResponse !== 'undefined') {
                  dataSet = raw.formResponse;
      ...
      $('#formFr').on('click', '.btnAdd', function (e) {
          ...
          fv.on('core.form.valid', async function () {
              ...
              await axios({
                  ...
                  data: { 
                    _formId: document.querySelector('#frFormId').value ,
                    response: document.querySelector('#frResponse').value ,
                  },
              }).then(function (res) {
      ...
      $('#formFr').on('click', '.btnSave', function (e) {
          ...
          fv.on('core.form.valid', async function () {
              ...
              await axios({
                  method: 'patch',
                  url: `${HOST_URL}/api/v1/form-response/${id}`,
                  data: {
                    _formId: document.querySelector('#frFormId').value ,
                    response: document.querySelector('#frResponse').value ,
                  },
      ...
      $('#tableFr').on('click', '.btnEdit', async function (e) {
          ...
          if (res.data.status == 'success') {
                  ...
                  document.querySelector('#frId').value = res.data.formResponse._id;
                  document.querySelector('#frFormId').value  = res.data.formResponse._formId;
                  document.querySelector('#frResponse').value  = res.data.formResponse.response;
              }
      ...
      $('#tableFr').on('click', '.btnDelete', function (e) {
          ...
          axios.delete(`${HOST_URL}/api/v1/form-response`, requests);
