    ...
    function _DeliveryNote() {
      ...
      $('#tableDn').on('click', '.btnEdit', async function (e) {
          ...
          if (res.data.status == 'success') {
                  ...
                  document.querySelector('#dnCosigneeEmail').value = res.data.deliveryNote.consigneeEmail;
                  document.querySelector('#dnCosigneeContact').value = res.data.deliveryNote.consigneeContactNumber;
