...
const AnnouncementNotifyTable = (function () {
    var dataSet;
    // Private functions
  
    const announcementNotifyTable = async () =>  {
      ...
      const options = {
        ...
        data: {
          ...
          source: {
            read: {
              method: 'get',
              url: `${HOST_URL}/api/v1/announcement/notify/table`,
              params: {
                fields: '_announcementId, priority, _recipientId, recipientEmail,isEmailSent,seenAt,sentAt, createdBy,createdAt,updatedAt',
              },
              map: function(raw) {
                // sample data mapping
                console.log('raw', raw);
    ...
    return {
      // public functions
      init: function () {
        announcementNotifyTable();
      },
    };
  })();
  
  jQuery(document).ready(function () {
    AnnouncementNotifyTable.init();
  });
