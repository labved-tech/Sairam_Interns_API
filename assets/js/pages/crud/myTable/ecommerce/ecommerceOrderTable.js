...
const EcommerceOrderTable = (function () {
    var dataSet;
    // Private functions
  
    const ecommerceOrderTable = async () =>  {
          ...
          source: {
            read: {
              ...
              map: function(raw) {
                ...
                if (typeof raw.ecommerceOrder !== 'undefined') {
                  dataSet = raw.ecommerceOrder;
