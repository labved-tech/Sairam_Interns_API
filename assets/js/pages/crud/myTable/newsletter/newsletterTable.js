...
const NewsletterTable = (function () {
    var dataSet;
    // Private functions
  
    const newsletterEntriesTable = async () =>  {
      ...
      const options = {
        ...
        data: {
          ...
          source: {
            read: {
              method: 'get',
              url: `${HOST_URL}/api/v1/newsletter/entries/table`,
              params: {
                fields: '_id,fromEmail, description, newsletterType,createdBy,createdAt,updatedAt,updatedBy',
              },
              map: function(raw) {
                // sample data mapping
                console.log('raw', raw);
                ...
                if (typeof raw.newsletterEntries !== 'undefined') {
                  dataSet = raw.newsletterEntries;
    ...
    const newsletterMessagesTable = async () => {
    ...
    return {
      // public functions
      init: function () {
        newsletterEntriesTable();
        newsletterMessagesTable();
      },
    };
  })();
