...
const FarmExportedStrategy = (function () {
    var dataSet;
    // Private functions
  
    const farmExportedStrategyTable = async () =>  {
        ...
        const options = {
          ...
          pagination: true,
          search: {
            input: $('#createFarmExportedStrategyTable'),
            key: 'generalSearch',
          },
    ...
    return {
      // public functions
      init: function () {
        farmExportedStrategyTable();
      },
    };
  })();
  
  jQuery(document).ready(function () {
    FarmExportedStrategy.init();
  });
