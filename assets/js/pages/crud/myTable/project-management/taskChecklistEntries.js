...
const TaskChecklistEntries = (function () {
    var dataSet;
    // Private functions
  
    const taskChecklistEntriesTable = async () =>  {
        ...
        const options = {
          ...
          pagination: true,
          search: {
            input: $('#createTaskChecklistEntriesTable'),
            key: 'generalSearch',
          },
    ...
    return {
      // public functions
      init: function () {
        taskChecklistEntriesTable();
      },
    };
  })();
  
  jQuery(document).ready(function () {
    TaskChecklistEntries.init();
  });
