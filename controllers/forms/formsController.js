...
exports.getAllTableForms = catchAsync(async (req, res, next) => {
  let query;
  // BUILD QUERY
  // 1A) Filtering
  ...
  if (req.query.pagination) {
    numRecords = await Forms.countDocuments(); // has to be replaced with query.countDocuments();
