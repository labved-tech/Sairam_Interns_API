...
exports.getAllTableProjectNotes = catchAsync(async (req, res, next) => {
  let query;
  // BUILD QUERY
  // 1A) Filtering
  ...
  query = ProjectNotes.find(searchObj);
  ...
  // EXECUTE QUERY
  const projectNotes = await query;
  //projectNotes = await ProjectNotes.find();
