...
exports.getAllTableReports = catchAsync(async (req, res, next) => {
  let query;
  // BUILD QUERY
  // 1A) Filtering
  ...
  if (req.query.pagination) {
    numRecords = await Reports.countDocuments(); // has to be replaced with query.countDocuments();
