...
exports.getAllTableQuotation = catchAsync(async (req, res, next) => {
  let query;
  // BUILD QUERY
  // 1A) Filtering
  ...
  query = Quotation.find(searchObj);
  ...
  if (req.query.pagination) {
    numRecords = await Quotation.countDocuments(); // has to be replaced with query.countDocuments();
